...
<body>
	...
	<table>
		<tr>
			<td class="h_zipcode">우편번호</td>
			<td class="h_address" style="text-align: center;">기본주소</td>
		</tr>
		
		<% for(ZipDTO zip:zipList) { %>
		<tr>
			<td class="h_zipcode"><%=zip.getZipcode() %></td>
			<%-- a 태그를 이용하여 자바스크립트 명령을 작성할 경우 반드시 javascript 접두사를 
			사용해야만 실행 가능 --%>
			<td class="h_address">
