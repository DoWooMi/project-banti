...
<%
	...
	int totalBoard=BoardDAO.getDAO().selectQnaBoardCount(search, keyword);
	...
	//DAO 클래스의 메소드 호출 - 검색 기능 구현시 호출하는 메소드
	List<BoardDTO> boardList=BoardDAO.getDAO().selectQnaBoardList(startRow, endRow, search, keyword);
...
<div id="wrapper" style="clear:both";>
	<div id="container">
		<div class="shop-content">
			<!-- 게시판 카테고리 시작 { -->
			<div id="wrapper_title">질문과 답변</div>
			<div id="bo_list" style="width:100%">
        		<div id="bo_cate" >
        			<ul id="bo_cate_ul">
            			<li><a href="<%=request.getContextPath()%>/index.jsp?menugroup=board&menu=board_list">전체</a></li>
            			<li><a href="<%=request.getContextPath()%>/index.jsp?menugroup=board&menu=board_list_qna" id="bo_cate_on">질문과답변</a></li>
