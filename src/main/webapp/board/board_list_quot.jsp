...
<%
	...
	int totalBoard=BoardDAO.getDAO().selectQuotBoardCount(search, keyword);
	...
	//DAO 클래스의 메소드 호출 - 검색 기능 구현시 호출하는 메소드
	List<BoardDTO> boardList=BoardDAO.getDAO().selectQuotBoardList(startRow, endRow, search, keyword);
...
<script src="http://bant.co.kr/js/jquery-1.12.4.min.js"></script>
<style type="text/css">
</style>
<div id="wrapper" style="clear:both";>
	<div id="container">
		<div class="shop-content">
			<!-- 게시판 카테고리 시작 { -->
			<div id="wrapper_title">견적 요청</div>
			<div id="bo_list" style="width:100%">
        		<div id="bo_cate" >
        			<ul id="bo_cate_ul">
            			<li><a href="<%=request.getContextPath()%>/index.jsp?menugroup=board&menu=board_list">전체</a></li>
            			<li><a href="<%=request.getContextPath()%>/index.jsp?menugroup=board&menu=board_list_qna">질문과답변</a></li>
            			<li><a href="<%=request.getContextPath()%>/index.jsp?menugroup=board&menu=board_list_quot" id="bo_cate_on">견적요청</a></li>
            		</ul>
    			</div>
    			<!-- } 게시판 카테고리 끝 -->
...
<%-- 사용자로부터 검색어를 입력받아 게시글 검색 기능 구현 --%>
        		...
        		<ul class="btn_bo_user">
        	    	<li>
      				<select name="search" style="width:80px;height:25px;">
						<option value="h_name" selected="selected">&nbsp;작성자&nbsp;</option>
	...
	<% if(loginHewon!=null) {//로그인 사용자가 JSP 문서를 요청한 경우 %>
		<div class="bo_fx">
    	<ul class="btn_bo_user">
        	<li><a href="index.jsp?menugroup=board&menu=board_write" class="btn_b011 btn" title="글쓰기" >
